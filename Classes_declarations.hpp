...
class Entry {
    public:
        ...
        //int entry_id;
        //int associated_dimension;

        Entry *p_next;   //LL pointer
        //Entry *p_head;   //LL head, get the head of the LL from any object
        ...
        //void create_Entry( int dim, int id );

        //double retrieve_value_from_entry( int x, int y ); //int id

        void internal_set_value( double value );

        //void insert_into_LL( Entry *p_new );

        //void external_set_value( double value, int x, int y ); //int id

        //void print_Entry( int Entry_id );
